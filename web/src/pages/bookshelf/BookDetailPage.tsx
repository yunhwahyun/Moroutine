...
export default function BookDetailPage() {
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-gray-50">
      ...
      >
        {/* 버튼이 최대 4개까지 나오면서 제목과 한 줄에서 다투다 보니 제목이 거의 안 보이던 문제 —
            ...
            <div key={chapter.id} className="bg-white rounded-2xl p-4 shadow-sm">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button onClick={() => handleEditStart(chapter)} className="p-1.5 text-gray-400 hover:text-gray-700" aria-label="수정">
                    <EditIcon size={14} />
                  </button>
                </div>
              </div>
