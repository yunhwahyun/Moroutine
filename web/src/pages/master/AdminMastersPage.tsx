...
import { Section } from '@/components/ui/SettingsList'
      ...
      <div className="flex-1 overflow-y-auto pb-8">
        ...
        <div>
          ...
          <div className="mx-4 bg-white border border-gray-200 rounded-2xl p-4 flex flex-col gap-3">
            ...
            />
            {inviteError && <p className="text-red-500 text-xs text-center py-1">{inviteError}</p>}
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-lg border border-gray-200 text-gray-700 text-sm disabled:opacity-50"
              >
