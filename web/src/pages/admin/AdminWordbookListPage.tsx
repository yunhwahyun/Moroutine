          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-gray-900 truncate">{wb.title}</span>
                <span className="text-xs text-gray-400 shrink-0 ml-2">{STATUS_LABEL[wb.status]}</span>
              </div>
